...
run_stats run_benchmark(int run_id, benchmark_config* cfg, object_generator* obj_gen)
{
    ...
    ofstream latency_file("logs/dump/latency_" + to_string(run_id) + ".txt");
    ofstream throughput_file("logs/dump/throughput_" + to_string(run_id) + ".txt");
    ofstream avg_latency_file("logs/dump/avg_latency_" + to_string(run_id) + ".txt");
    ofstream avg_throughput_file("logs/dump/avg_throughput_" + to_string(run_id) + ".txt");
    ...
    do {
        ...
        latency_file << cur_latency << std::endl;
        throughput_file << cur_ops_sec << std::endl;
        avg_latency_file << avg_latency << std::endl;
        avg_throughput_file << ops_sec << std::endl;
    ...
    //     fprintf(stderr, "%.4f\n", redis_stats["total.allocated"] - redis_stats["startup.allocated"]);
    // }
    // else {
    //     fprintf(stderr, "%.4f\n", memcached_stats[b"bytes"]);
    // }
